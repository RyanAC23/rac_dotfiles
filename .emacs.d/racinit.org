...
* Old Packages
Things I no longer use but haven't deleted from this doc yet.
** RSS - Elfeed
I tried this for a while but didn't use it much. I'll tag the section out rather than delete it completely, just in case.
#+BEGIN_SRC emacs-lisp
  ;; (use-package elfeed
  ;;   :commands (elfeed)
  ;;   :config
