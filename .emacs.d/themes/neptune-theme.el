...
(deftheme neptune "DOCSTRING for neptune")
  (custom-theme-set-faces 'neptune
   ...
   '(mode-line ((t (:foreground "#29222e" :background "#838383" ))))
   ...
   '(font-lock-function-name-face ((t (:foreground "#7826bb" ))))
   '(font-lock-keyword-face ((t (:foreground "#65d7a8" ))))
   '(font-lock-string-face ((t (:foreground "#fee8ff" ))))
